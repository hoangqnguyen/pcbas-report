...
The SoccerNet PCBAS~\cite{deliege2021soccernet,cioppa2024soccernet} tactical data provides 13-column per-frame player tracking at 1920$\times$1080, 25fps. However, $\sim$22\% of tracked players are missing bounding boxes and no ball position is provided. We address both gaps with SAM3-based~\cite{ravi2024sam2} pipelines.
